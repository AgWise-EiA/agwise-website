	...
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			...
			echo '<div class="notice-content">';
				echo '<h2>'. esc_html__( 'Welcome to WPElemento', 'elemento-it-solutions' ) .'</h2>';
				echo '<p>'. esc_html__( 'Thank you for choosing Elemento IT Solutions theme .To setup the theme, please visit the get started page.', 'elemento-it-solutions' ) .'</p>';
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=elemento_it_solutions_about' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'elemento-it-solutions' ) .'</a></span>';
			echo '</div>';
		echo '</div>';
	echo '</div>';
}
...
if (!function_exists('elemento_it_solutions_widgets_init')) {
	...
	function elemento_it_solutions_widgets_init() {
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Page Sidebar','elemento-it-solutions'),
			'id'   => 'sidebar-2',
			'description'   => esc_html__('This sidebar will be shown on pages.', 'elemento-it-solutions'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Sidebar three','elemento-it-solutions'),
			'id'   => 'sidebar-3',
			'description'   => esc_html__('This sidebar will be shown on blog pages.', 'elemento-it-solutions'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 1','elemento-it-solutions'),
			'id'   => 'footer1-sidebar',
			'description'   => esc_html__('It appears in the footer 1.', 'elemento-it-solutions'),
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 2','elemento-it-solutions'),
			'id'   => 'footer2-sidebar',
			'description'   => esc_html__('It appears in the footer 2.', 'elemento-it-solutions'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 3','elemento-it-solutions'),
			'id'   => 'footer3-sidebar',
			'description'   => esc_html__('It appears in the footer 3.', 'elemento-it-solutions'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Footer sidebar 4','elemento-it-solutions'),
			'id'   => 'footer4-sidebar',
			'description'   => esc_html__('It appears in the footer 4.', 'elemento-it-solutions'),
			'before_widget' => '<aside id="%1$s" class="%2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>'
...
function elemento_it_solutions_logo_resizer() {

    $elemento_it_solutions_theme_logo_size_css = '';
    $elemento_it_solutions_logo_resizer = get_theme_mod('elemento_it_solutions_logo_resizer');

	$elemento_it_solutions_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($elemento_it_solutions_logo_resizer).'px !important;
			width: '.esc_attr($elemento_it_solutions_logo_resizer).'px !important;
		}
	';
    wp_add_inline_style( 'elemento-it-solutions-style',$elemento_it_solutions_theme_logo_size_css );

}
add_action( 'wp_enqueue_scripts', 'elemento_it_solutions_logo_resizer' );
...
function elemento_it_solutions_customize_css() {
	?>
	<?php if ( 'right' == get_theme_mod( 'elemento_it_solutions_sale_badge_position', 'right' ) ) : ?>
		<style>
		.woocommerce ul.products li.product .onsale {
			left: auto; right: 10px;
		}
		</style>
	<?php elseif ( 'left' == get_theme_mod( 'elemento_it_solutions_sale_badge_position', 'right' ) ) : ?>
		<style>
		.woocommerce ul.products li.product .onsale{
...
define('ELEMENTO_IT_SOLUTIONS_THEME_BUNDLE',__('https://www.wpelemento.com/elementor/wordpress-theme-bundle/','elemento-it-solutions'));
