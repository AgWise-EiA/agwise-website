		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 text-md-right text-center align-self-center">
				...
				<?php if ( get_theme_mod('elemento_it_solutions_header_email') ) : ?>
					<a href="mailto:<?php echo esc_url( get_theme_mod('elemento_it_solutions_header_email' ) ); ?>"><span ><i class="fas fa-paper-plane mr-2"></i><?php echo esc_html( get_theme_mod('elemento_it_solutions_header_email' ) ); ?></span></a>
				<?php endif; ?>
			</div>
